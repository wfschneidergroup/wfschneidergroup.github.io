...
<style>
    ...
    .hover-logo:hover {
      transform: scale(1.5); /* Scaled down slightly to 1.2 for a cleaner look */
    }

    /* 2. THE FIX: Remove the "Underline" or "Border" from the link itself */
    .social-link {
      text-decoration: none !important; /* Removes standard underline */
      border-bottom: none !important;  /* Removes theme-specific border lines */
      box-shadow: none !important;     /* Removes theme-specific shadow lines */
      display: inline-block;           /* Ensures the link area matches the logo */
    }

    /* Extra safety: ensure no line appears even when hovering the link */
    .social-link:hover {
...
Email: <span style="color: #0000EE;">wschneider@nd.edu</span> <br/>
Phone: (574) 631-8754  
Fax: (574) 631-8366  
...
<a href="https://www.linkedin.com/in/williamfschneider/" target="_blank" rel="noopener noreferrer" class="social-link">
  <img src="{{ '/group_data/people_photos/LinkedIn_logo_initials.png' | relative_url }}" class="hover-logo" style="width:25px; vertical-align:middle;">
</a>
&nbsp;&nbsp; 
<a href="https://twitter.com/profwschneider" target="_blank" rel="noopener noreferrer" class="social-link">
  <img src="{{ '/group_data/people_photos/twitter_logo.jpg' | relative_url }}" class="hover-logo" style="width:40px; vertical-align:middle;">
</a>
&nbsp;&nbsp;
<a href="https://github.com/wfschneidergroup" target="_blank" rel="noopener noreferrer" class="social-link">
  <img src="{{ '/group_data/people_photos/github_logo.png' | relative_url }}" class="hover-logo" style="width:35px; vertical-align:middle;">
</a>
